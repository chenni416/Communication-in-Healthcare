    ...
    <div className="space-y-6">
      ...
      <section aria-labelledby="h-e">
        <div className="mb-2 flex flex-wrap items-center gap-3">
          <h2 id="h-e" className="text-lg font-medium">新事件</h2>
          <h2 id="h-e" className="text-lg font-medium">緊急感測警報 (Emergency Alerts)</h2>
          <TechTag label="系統觸發" tech="Red Flag Rules (Python 純程式)" scope="無 LLM 介入，命中即推播，不可關閉" />
        </div>
      ...
      <section aria-labelledby="h-c">
        <div className="mb-2 flex flex-wrap items-center gap-3">
          <h2 id="h-c" className="text-lg font-medium">待審核</h2>
          <h2 id="h-c" className="text-lg font-medium">AI 護理草稿待審核 (Pending AI Drafts)</h2>
          <TechTag label="Nurse Assist Agent" tech="GPT-5.6-luna + LangGraph Interrupt" scope="AI 預填 ISBAR，需護理師確認後才正式寫入" />
        </div>
      ...
      <section aria-labelledby="h-t">
        ...
        <h2 id="h-t" className="mb-2 text-lg font-medium">今日總覽 (Today's Overview - Alert Priority)</h2>
